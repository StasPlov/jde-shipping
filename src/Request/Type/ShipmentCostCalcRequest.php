...
final class ShipmentCostCalcRequest extends Request
{
	const PRIVATE = true;
	const METHOD = 'GET';
	...
	/**
	 * Идентификатор филиала откуда отправляется груз (Обязательный параметр)
	 * @var string|null
	 */
	private ?string $from = null;

	/**
	 * Идентификатор филиала куда отправляется груз (Обязательный параметр).
	 * Список филиалов можно получить с помощью getGeoSearchRequest()
	 * @var string|null
	 */
	...
	/**
	 * Признак обязательной маркировки груза 
	 * 0 - Самостоятельная маркировка груза
	 * 1 - либо отсутствие признака - платная маркировка груза на филиале ЖДЭ
	 * @var int|null
	 */
